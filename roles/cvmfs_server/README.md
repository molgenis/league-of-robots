...
Some commands to check the setup of your startum 0 server:
...
In order to mount the newly created repo on the client, these configurations are needed on the client:
